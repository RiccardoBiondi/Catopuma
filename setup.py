...
# Package-Metadata
NAME = "catopuma"
DESCRIPTION = 'Custom Advanced Tensorflow Objects to Preprocess, Upload, Model and Augment'
URL = 'https://github.com/RiccardoBiondi/Catopuma'
EMAIL = 'riccardo.biondi7@unibo.it'
AUTHOR = 'Riccardo Biondi'
VERSION = None
KEYWORDS = 'artificial-intelligence deep-learning oop tensorflow keras pytorch'
REQUIREMENTS_FILENAME = os.path.join(here, 'requirements.txt')
VERSION_FILENAME = os.path.join(here, 'catopuma', '__version__.py')
